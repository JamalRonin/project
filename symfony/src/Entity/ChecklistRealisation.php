...
use App\Repository\ChecklistRealisationRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=ChecklistRealisationRepository::class)
 */
class ChecklistRealisation
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Realisation::class, inversedBy="checklist")
     */
    private $realisation;
